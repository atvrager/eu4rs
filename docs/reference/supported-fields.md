...
| `diplomatic_reputation` | ✅ | - | - |  |
| `employed_advisor` | ✅ | - | - |  |
| `event_target_agenda_country` | ✅ | - | - |  |
| `event_target_agenda_province` | ✅ | - | - |  |
| `event_target_agenda_trade_node` | ✅ | - | - |  |
| `factor` | ✅ | - | - |  |
...
| `elector` | ✅ | - | - |  |
| `emperor` | ✅ | - | - |  |
| `event_target_church_demolition` | ✅ | - | - |  |
| `export_to_variable` | ✅ | - | - |  |
| `from` | ✅ | - | - |  |
| `government` | ✅ | - | - |  |
| `has_country_flag` | ✅ | - | - |  |
...
| `custom_tooltip` | ✅ | - | - |  |
| `define_consort` | ✅ | - | - |  |
| `determine_value_of_trade_goods_trade_goods` | ✅ | - | - |  |
| `dip_add_dip_power` | ✅ | - | - |  |
...
| `can_select_type_privilege_for_estate` | ✅ | - | - |  |
| `capital_scope` | ✅ | - | - |  |
| `continent` | ✅ | - | - |  |
| `culture_group` | ✅ | - | - |  |
| `current_debate` | ✅ | - | - |  |
...
| `has_country_modifier` | ✅ | - | - |  |
| `has_estate_privilege` | ✅ | - | - |  |
| `has_exempt_from_seize_land_for_estate` | ✅ | - | - |  |
| `has_global_flag` | ✅ | - | - |  |
| `has_government_attribute` | ✅ | - | - |  |
| `has_heir` | ✅ | - | - |  |
| `has_idea` | ✅ | - | - |  |
